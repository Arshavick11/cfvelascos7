using cfvelascos7.Modelos;
using System;
using System.Net;
using System.Threading.Tasks;

namespace cfvelascos7.VISTAS;
public partial class ActualizarEliminar : ContentPage
{
    ...
    private void btnActualizar_Clicked(object sender, EventArgs e)
    {
        try
        {
            ...
            string url = "http://192.168.56.1/moviles/post.php?codigo=" + codigo + "&nombre=" + nombre + "&apellido=" + apellido + "&edad=" + edad;
    ...
    private void btnEliminar_Clicked(object sender, EventArgs e)
    {
        try
        {
            ...
            string url = "http://192.168.56.1/moviles/post.php?codigo=" + codigo;
            WebClient cliente = new WebClient();
            var parametros = new System.Collections.Specialized.NameValueCollection();
